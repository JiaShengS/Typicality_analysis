...
class Point:
    def __init__(self, pointInfo):
        ...
        self.x = pointInfo[1]
        self.y = pointInfo[2]
        self.keywords = pointInfo[3]
        self.attribute = pointInfo[4]
...
class Node():
    def __init__(self, Bvalue, level):
        ...
        self.range = []
        self.centre = []
        self.Bvalue = Bvalue  # Upper limit of the node, initial 25.
        self.paren = None
        self.level = level
        # self.keywords = []
        self.keywords = {}
    ...
    def update(self, child):
        ...
        if isinstance(child, Point):
            ...
            # self.bitmap = self.bitmap|child.bitmap # 按位取或
            # self.keywords = child.keywords + " "
            # self.keywords="".join(list(set(self.keywords)))
            # print(self.keywords)    # 验证正确

        elif isinstance(child, Node):
            self.updateRange(child.range)
            # self.bitmap = self.bitmap| child.bitmap
            # for keyword in child.keywords:
            # print(type(self.keywords))
            # self.keywords.append(child.keywords)

            # self.keywords = "".join(self.keywords)
            # print(self.keywords)
            '''for attr in child.attribute:
        ...
        # self.attribute = skyline(self.attribute) # 得到所有子节点属性值的skyline points
        # print(self.attribute, self.bitmap)
...
class Leaf(Node):  # super class Node
    def __init__(self, Bvalue, level, point):
        ...
        # print(type(self.keywords))
        # self.keywords = self.keywords.append(point.keywords)
        # print(self.attribute,self.bitmap)
